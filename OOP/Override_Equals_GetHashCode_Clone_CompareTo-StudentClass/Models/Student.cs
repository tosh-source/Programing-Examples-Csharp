...
//Condition** --> Compare by names, then by Social Security Number. NOTE: Students may have same names, but Social Security Number should be different, if not and the numbers are equals - they are the same persons.
